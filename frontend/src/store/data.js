...
export const resourcesSeed = [
  { id: 'rc1', name: 'LED Wall 4K 12m²', category: 'LED Screens', qty: 2, allocated: 1, rented: 1, maintenance: 0, status: 'in-use', location: 'Main Warehouse', code: 'A-LE-01', image: '', unitCost: 450000, rentalAvailable: true, rentalRate: 25000, rentalDeposit: 50000, supplier: 'Addis AV Traders', purchaseDate: '2024-03-15', rentalTerms: 'Includes certified video technician for rigging & live switching.', notes: 'Hire-ready; spare power modules in stock.' },
  { id: 'rc2', name: 'Line Array Sound System', category: 'Sound Systems', qty: 3, allocated: 1, rented: 1, maintenance: 0, status: 'available', location: 'Main Warehouse', code: 'A-SD-02', image: '', unitCost: 380000, rentalAvailable: true, rentalRate: 18000, rentalDeposit: 30000, supplier: 'JBL Ethiopia', purchaseDate: '2023-11-20', rentalTerms: 'Full PA with 2 subwoofers and mixing board; sound engineer provided.', notes: 'Full PA with 2 subwoofers and mixing desk.' },
  { id: 'rc3', name: 'Moving Head Lights', category: 'Lighting', qty: 24, allocated: 14, rented: 0, maintenance: 2, status: 'available', location: 'Main Warehouse', code: 'A-LT-03', image: '', unitCost: 85000, rentalAvailable: true, rentalRate: 1500, rentalDeposit: 10000, supplier: 'Beam Lights Co', purchaseDate: '2024-01-10', rentalTerms: 'DMX cables and clamps provided; deposit refunded upon inspection.', notes: 'DMX controlled; two units under service.' },
  { id: 'rc4', name: 'Truss Stage (modular)', category: 'Stages', qty: 4, allocated: 1, rented: 0, maintenance: 0, status: 'available', location: 'Stage Warehouse', code: 'A-ST-04', image: '', unitCost: 210000, rentalAvailable: true, rentalRate: 12000, rentalDeposit: 20000, supplier: 'TrussPro', purchaseDate: '2023-06-05', rentalTerms: 'Covers up to 6m×4m per module with safety handrails.', notes: 'Covers up to 6m×4m per module.' },
  { id: 'rc5', name: 'Banquet Chairs', category: 'Furniture', qty: 400, allocated: 160, rented: 100, maintenance: 0, status: 'available', location: 'Hall Storage', code: 'A-FR-05', image: '', unitCost: 3500, rentalAvailable: true, rentalRate: 25, rentalDeposit: 2000, supplier: 'Furniture World', purchaseDate: '2022-05-18', rentalTerms: 'White padded chairs; chair covers provided on request.', notes: 'White padded chairs; covers available.' },
  { id: 'rc6', name: 'Flower Arches', category: 'Decoration', qty: 12, allocated: 6, rented: 0, maintenance: 1, status: 'available', location: 'Decoration Store', code: 'A-DR-06', image: '', unitCost: 18000, rentalAvailable: true, rentalRate: 4500, rentalDeposit: 5000, supplier: 'Floral Studio', purchaseDate: '2024-02-12', rentalTerms: 'Choice of white or rose florals; indoor/outdoor weighted base.', notes: 'Compatible with white & rose florals.' },
  { id: 'rc7', name: '4x4 Utility Truck', category: 'Vehicles', qty: 3, allocated: 2, rented: 0, maintenance: 0, status: 'available', location: 'Fleet Yard', code: 'A-VH-07', image: '', unitCost: 2200000, rentalAvailable: true, rentalRate: 6500, rentalDeposit: 15000, supplier: 'Toyota Ethiopia', purchaseDate: '2023-01-30', rentalTerms: 'Amen licensed driver included; fuel provided by client.', notes: 'Diesel; trailers available for freight.' },
  { id: 'rc8', name: 'Diesel Generators', category: 'Generators', qty: 2, allocated: 0, rented: 1, maintenance: 0, status: 'available', location: 'Fleet Yard', code: 'A-GN-08', image: '', unitCost: 640000, rentalAvailable: true, rentalRate: 14000, rentalDeposit: 25000, supplier: 'Genset PLC', purchaseDate: '2022-09-14', rentalTerms: '65kVA silent generator; initial fuel included; technician standby available.', notes: 'Backup power for outdoor staging.' },
  { id: 'rc9', name: 'Branding Banners', category: 'Branding', qty: 50, allocated: 12, rented: 10, maintenance: 0, status: 'available', location: 'Print Store', code: 'A-BR-09', image: '', unitCost: 4500, rentalAvailable: true, rentalRate: 500, rentalDeposit: 1000, supplier: 'PrintHub', purchaseDate: '2024-04-01', rentalTerms: 'Standard 85x200cm aluminum pull-up stands with carry bags.', notes: 'Rolled banners with stands; reprint on request.' },
]

// ----------------------------- RENTALS / EQUIPMENT HIRE -----------------------------
export const rentalsSeed = [
  {
    id: 'rnt1',
    rentalCode: 'RNT-2026-001',
    resourceId: 'rc1',
    resourceName: 'LED Wall 4K 12m²',
    qty: 1,
    renterType: 'client',
    clientId: 'cl1',
    renterName: 'ETH FINTECH Group',
    renterPhone: '+251 911 222 000',
    renterEmail: 'meron@ethfintech.com',
    renterCompany: 'ETH FINTECH Group',
    ...
    status: 'active',
    conditionOnOut: 'Pristine, tested with Novastar controller',
    actualReturnDate: '',
    conditionOnReturn: '',
    notes: 'Rigging technician dispatched. Client requested early 07:00 AM setup.',
    createdAt: '2026-08-10',
  },
  {
    id: 'rnt2',
    rentalCode: 'RNT-2026-002',
    resourceId: 'rc2',
    resourceName: 'Line Array Sound System',
    qty: 1,
    renterType: 'external',
    clientId: null,
    renterName: 'Addis Grand Gala Events',
    renterPhone: '+251 912 884 920',
    renterEmail: 'info@addisgrandgala.et',
    renterCompany: 'Addis Grand Gala Events',
    ...
    status: 'active',
    conditionOnOut: '2 subwoofers + 2 main arrays + 24-channel digital board',
    actualReturnDate: '',
    conditionOnReturn: '',
    notes: 'Customer arranged warehouse pickup. Sound test completed prior to dispatch.',
    createdAt: '2026-08-11',
  },
  {
    id: 'rnt3',
    rentalCode: 'RNT-2026-003',
    resourceId: 'rc8',
    resourceName: 'Diesel Generators',
    qty: 1,
    renterType: 'external',
    clientId: null,
    renterName: 'Bole Open Air Cinema',
    renterPhone: '+251 913 771 004',
    renterEmail: 'contact@bolecinema.et',
    renterCompany: 'Bole Open Air Cinema',
    ...
    paymentMethod: 'Bank Transfer',
    status: 'active',
    conditionOnOut: '65kVA silent generator, full diesel tank, oil inspected',
    actualReturnDate: '',
    conditionOnReturn: '',
    notes: 'Advance ETB 30,000 received; balance of ETB 26,000 due upon equipment return.',
    createdAt: '2026-07-30',
  },
  {
    id: 'rnt4',
    rentalCode: 'RNT-2026-004',
    resourceId: 'rc5',
    resourceName: 'Banquet Chairs',
    qty: 100,
    renterType: 'client',
    clientId: 'cl2',
    renterName: 'Zemen Pharmaceuticals',
    renterPhone: '+251 912 333 111',
    renterEmail: 'rahel@zemenpharma.com',
    renterCompany: 'Zemen Pharmaceuticals',
    ...
    paymentMethod: 'Telebirr',
    status: 'returned',
    conditionOnOut: '100 white padded banquet chairs in protective sleeves',
    actualReturnDate: '2026-08-10',
    conditionOnReturn: 'Good condition, 100/100 accounted for, no fabric tears',
    notes: 'Returned on schedule; full ETB 2,000 security deposit refunded.',
    createdAt: '2026-08-05',
  },
  {
    id: 'rnt5',
    rentalCode: 'RNT-2026-005',
    resourceId: 'rc9',
    resourceName: 'Branding Banners',
    qty: 10,
    renterType: 'external',
    clientId: null,
    renterName: 'Sheger University Career Fair',
    renterPhone: '+251 914 202 339',
    renterEmail: 'careers@sheger.edu.et',
    renterCompany: 'Sheger University',
    ...
    paymentMethod: 'Cash',
    status: 'active',
    conditionOnOut: '10 aluminum pull-up banner stands with clean bases',
    actualReturnDate: '',
    conditionOnReturn: '',
    notes: 'Delivered to university main auditorium. Cash payment settled upon receipt.',
