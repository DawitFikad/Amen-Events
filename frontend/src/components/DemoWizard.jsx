...
const steps = [
  { title: 'Dashboard Overview', desc: 'Review KPIs, charts and team performance.', route: '/erp/dashboard', intent: null, icon: LayoutDashboard, marker: 'dashboard' },
  { title: 'Create a New Client', desc: 'Add a company + contact to the CRM pipeline.', route: '/erp/crm', intent: 'new-client', icon: Users, marker: 'client' },
  { title: 'Create an Event', desc: 'Build the event, linked to your client.', route: '/erp/admin/events', intent: 'new-event', icon: CalendarDays, marker: 'event' },
  { title: 'Assign Team Members', desc: 'Pick the project manager and crew for the event.', route: '/erp/admin/events', intent: 'event-team', icon: UserPlus, marker: 'team' },
  { title: 'Allocate Venue & Resources', desc: 'Book the venue and allocate equipment.', route: '/erp/admin/events', intent: 'event-resources', icon: MapPin, marker: 'allocate' },
  { title: 'Create Budget', desc: 'Set the event budget and view spend.', route: '/erp/admin/events', intent: 'event-budget', icon: Wallet, marker: 'budget' },
  { title: 'Register Attendees', desc: 'Add attendees and ticket types.', route: '/erp/ticketing', intent: 'new-registration', icon: Ticket, marker: 'register' },
  { title: 'Generate QR Tickets', desc: 'Open the digital QR ticket for an attendee.', route: '/erp/ticketing', intent: 'view-qr', icon: QrCode, marker: 'qr' },
  { title: 'Perform QR Check-in', desc: 'Scan the ticket at the entrance.', route: '/erp/checkin', intent: 'checkin', icon: ScanLine, marker: 'checkin' },
  { title: 'Track Expenses & Payments', desc: 'Record costs and client payments.', route: '/erp/finance', intent: 'finance', icon: TrendingUp, marker: 'finance' },
  { title: 'Generate Reports', desc: 'Export the event and financial reports.', route: '/erp/reports', intent: 'reports', icon: BarChart3, marker: 'reports' },
  { title: 'Complete Event', desc: 'Mark the event as completed.', route: '/erp/admin/events', intent: 'event-complete', icon: CheckCircle2, marker: 'complete' },
]
