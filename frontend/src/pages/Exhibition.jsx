...
export default function Exhibition() {
  ...
  const exhibitorSchema = {
    ...
    contact: [optional(nameOnly('Contact name'))],
    email: [optional(emailValid('Contact email'))],
    phone: [optional(phoneValid('Contact phone'))],
    ...
    <div>
        ...
        <div className="card overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[860px]">
              <thead className="bg-brand-50/50"><tr><Th>Company</Th><Th>Booth</Th><Th>Package</Th><Th>Size</Th><Th>Contact</Th><Th className="text-right">Paid</Th><Th>Status</Th><Th /></tr></thead>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title={editingId ? 'Edit Exhibitor' : 'Register Exhibitor'} width="max-w-xl">
        <div className="grid grid-cols-2 gap-3">
          ...
          <Field label="Booth Size"><select className="input" value={form.size || 'Standard'} onChange={(e) => setForm({ ...form, size: e.target.value })}><option>Premium</option><option>Featured</option><option>Standard</option></select></Field>
          ...
          <Field label="Website"><input className="input" value={form.website || ''} onChange={(e) => setForm({ ...form, website: e.target.value })} placeholder="company.com" /></Field>
